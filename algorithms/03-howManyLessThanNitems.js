//logarithmic-num-less-than-demo

function howManyLessThanNitems(arr, n) {
  let ticks = 0;

  // if the first element in the array is greater than `n`, return 0,
...
getRunTimeOperations(howManyLessThanNitems, { arr: [1, 2, 3], n: 2 });
getRunTimeOperations(howManyLessThanNitems, {
...
//----output
// With input of size 3, howManyLessThanNitems clocked 3 ticks to generate result of 1.
// With input of size 10, howManyLessThanNitems clocked 3 ticks to generate result of 8.
// With input of size 100, howManyLessThanNitems clocked 13 ticks to generate result of 98.
// With input of size 1000, howManyLessThanNitems clocked 19 ticks to generate result of 998.
